...
import com.devedidayg.drinkapp.Models.ExtendedIngredient;
...
public class IngredientsAdapter extends RecyclerView.Adapter<IngredientsViewHolder>{
    ...
    public IngredientsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new IngredientsViewHolder(LayoutInflater.from(context).inflate(R.layout.list_drinks_ingredients, parent, false));
