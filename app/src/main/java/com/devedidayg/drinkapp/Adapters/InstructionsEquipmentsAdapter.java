...
import com.devedidayg.drinkapp.Models.Equipment;
import com.devedidayg.drinkapp.Models.Ingredient;
...
public class InstructionsEquipmentsAdapter extends RecyclerView.Adapter<InstructionEquipmentsViewHolder>{
    ...
    public void onBindViewHolder(@NonNull InstructionEquipmentsViewHolder holder, int position) {
        ...
        holder.textView_instructions_items.setText(list.get(position).name);
        holder.textView_instructions_items.setSelected(true);
...
class InstructionEquipmentsViewHolder extends RecyclerView.ViewHolder {
    ...
    TextView textView_instructions_items;

    public InstructionEquipmentsViewHolder(@NonNull View itemView) {
        super(itemView);

        textView_instructions_items = itemView.findViewById(R.id.textView_instructions_items);
